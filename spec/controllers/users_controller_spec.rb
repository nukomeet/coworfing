...
describe UsersController do
  ...
  describe "GET 'index'" do
    before :each do
      @private = FactoryGirl.create_list(:user, 1, :regular, public: false)
      @public = FactoryGirl.create_list(:user, 1,  :regular, public: true)
    end
...
=end
    ...
    context "whit regular user logged in" do
      ...
      it "assigns public Users to @users" do
        sign_in regular
        get :index
        assigns(:users).should match_array(@private + @public + [regular])
      end
    end
  end
